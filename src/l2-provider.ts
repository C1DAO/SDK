...
import { predeploys, getContractInterface } from '@vmeta3/contracts'
...
/**
 * Returns an provider wrapped as an Vmeta3 L2 provider. Adds a few extra helper functions to
 * simplify the process of estimating the gas usage for a transaction on Vmeta3. Returns a COPY
...
export const asL2Provider = <TProvider extends Provider>(
  ...
  // Modify the block formatter to return the state root. Not strictly related to Vmeta3, just a
