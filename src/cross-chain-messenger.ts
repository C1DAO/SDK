...
import { sleep, remove0x } from '@vmeta3/core-utils'
import { predeploys } from '@vmeta3/contracts'
...
export class CrossChainMessenger implements ICrossChainMessenger {
  ...
  //     getMessagesByAddress will be enabled by plugging in an Vmeta3 Indexer (coming soon).
  //     See the following issue on GitHub for additional context:
  //     https://github.com/vmeta3/vmeta3-chain/issues/2129
  //   `)
  // }
  ...
  public async getMessageProof(
    ...
    // https://github.com/vmeta3/vmeta3-chain/blob/c84d3450225306abbb39b4e7d6d82424341df2be/packages/contracts/contracts/L2/predeploys/OVM_L2ToL1MessagePasser.sol#L23
