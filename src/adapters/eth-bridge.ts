...
import { hexStringEquals } from '@vmeta3/core-utils'
...
export class ETHBridgeAdapter extends StandardBridgeAdapter {
    ...
    return events
      .filter((event) => {
        ...
        return (
          ...
          hexStringEquals(event.args._l2Token, predeploys.WETH9)
        )
      })
      .map((event) => {
        return {
  ...
  public async supportsTokenPair(
    ...
    return (
      ...
      hexStringEquals(toAddress(l2Token), predeploys.WETH9)
    )
  }
